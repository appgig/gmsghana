...
<head>
  ...
  <title>Guardian Management Services</title>
...
<body>
  ...
  <section id="hero">
    ...
    <div class="container">
      ...
      <div class="headIntro col-lg-6 py-5 py-lg-0 order-2 order-lg-1" data-aos="fade-right">
        <h1>Guardian Management Services</h1>
        <h2>Guardian Management Services (GMS) Ghana Limited is a private limited liability company registered in Ghana.</h2>
  ...
  <main id="main">
    ...
    <section id="clients" class="clients section-bg">
      <div class="container">
        ...
        <p>
          <h2 class="text-center">Our Affiliations</h2>
        </p>
        ...
        <div class="row">
          ...
          <div class="col-xl-7 pl-0 pl-lg-5 pr-lg-1 d-flex align-items-stretch">
            <div class="content d-flex flex-column justify-content-center">
              ...
              <p data-aos="fade-in">
                Guardian Management Services (GMS) Ghana Limited is a private limited liability company registered in Ghana.  GMS provides a wide range of Fund Administrative Services to backstop Funds and other companies to achieve optimal success.
              </p>
              <p data-aos="fade-in" style="margin-top: 20px;">
                GMS offer a range of fund services from set-up to administration and accounting with a personalized service approach to our clients. Our experience team work with clients as a strategically to ensure compliance with all regulatory issues.  
              </p>
              <div class="row">
                <div class="col-md-6 icon-box" data-aos="fade-up">
                  <i class="bx bx-receipt"></i>
                  <h4><a href="services.php">Corporate Secretarial and Client Services</a></h4>
                  <p>Our Service</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                  <i class="bx bx-cube-alt"></i>
                  <h4><a href="services.php">VC/PE Services</a></h4>
                  <p>Our Service</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                  <i class="bx bx-images"></i>
                  <h4><a href="services.php">Escrow Services</a></h4>
                  <p>Our Service</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
                  <i class="bx bx-shield"></i>
                  <h4><a href="services.php">Compliance Services</a></h4>
                  <p>Our Service</p>
                </div>
              </div>
            </div><!-- End .content-->
    ...
    <section id="services" class="services section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p data-aos="fade-in">We provide the following services...</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/seccretary.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="services.php">Corporate Secretarial and Client Services</a></h5>
                <p class="card-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo</p>
                <div class="read-more"><a href="services.php"><i class="icofont-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-right">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/valuation.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="services.php">VC/PE Services</a></h5>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/governance.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="services.php">Escrow Services</a></h5>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/due-dilligence.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="services.php">Compliance Services</a></h5>
                <p class="card-text">Nostrum eum sed et autem dolorum perspiciatis. Magni porro quisquam laudantium voluptatem. In molestiae earum ab sit esse voluptatem. Eos ipsam cumque ipsum officiis qui nihil aut incidunt aut</p>
                <div class="read-more"><a href="services.php"><i class="icofont-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/dominini.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="services.php">Domiciliation Management</a></h5>
                <p class="card-text">Nostrum eum sed et autem dolorum perspiciatis. Magni porro quisquam laudantium voluptatem. In molestiae earum ab sit esse voluptatem. Eos ipsam cumque ipsum officiis qui nihil aut incidunt aut</p>
                <div class="read-more"><a href="services.php"><i class="icofont-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/accounting.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="services.php">Accounting and Payroll Services</a></h5>
                <p class="card-text">Nostrum eum sed et autem dolorum perspiciatis. Magni porro quisquam laudantium voluptatem. In molestiae earum ab sit esse voluptatem. Eos ipsam cumque ipsum officiis qui nihil aut incidunt aut</p>
                <div class="read-more"><a href="services.php"><i class="icofont-arrow-right"></i> Read More</a></div>
              </div>
            </div>
    ...
    <!-- ======= Features Section ======= -->
    <section id="features" style="display: none;" class="features section-bg">
      <div class="container">
    ...
    <!-- ======= Portfolio Section ======= -->
    <section id="portfolio" style="display: none;" class="portfolio section-bg">
      <div class="container">
    ...
    <!-- ======= Team Section ======= -->
    <section id="team" style="display: none;" class="team section-bg">
      <div class="container">
    ...
    <!-- ======= Pricing Section ======= -->
    <section id="pricing" style="display: none;" class="pricing section-bg">
      <div class="container">
    ...
    <section id="contact" class="contact section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p data-aos="fade-in">We are happy to help</p>
        </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box" data-aos="fade-up">
                  <i class="bx bx-map"></i>
                  <h3>Our Address</h3>
                  <p>Newtown, Accra <br> Sika Plaza <br> Dome - Pillar II Road <br> </p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box mt-4" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <h3>Email Us</h3>
                  <p>info@gmsghana.com<br>admin@gmsghana.com</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box mt-4" data-aos="fade-up" data-aos-delay="100">
