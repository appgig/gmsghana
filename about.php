...
<body>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/fund.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Fund Administration</a></h5>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-right">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="">Back Office Accounting Services</a></h5>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-right">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="">Corporate Secretarial Services</a></h5>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="">Corporate Governance Services</a></h5>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="">Due Diligence</a></h5>
                <p class="card-text">Nostrum eum sed et autem dolorum perspiciatis. Magni porro quisquam laudantium voluptatem. In molestiae earum ab sit esse voluptatem. Eos ipsam cumque ipsum officiis qui nihil aut incidunt aut</p>
                <div class="read-more"><a href="#"><i class="icofont-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="">Corproate Valuation services</a></h5>
                <p class="card-text">Nostrum eum sed et autem dolorum perspiciatis. Magni porro quisquam laudantium voluptatem. In molestiae earum ab sit esse voluptatem. Eos ipsam cumque ipsum officiis qui nihil aut incidunt aut</p>
                <div class="read-more"><a href="#"><i class="icofont-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/equity.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">General Partner Entity and Management Companies</a></h5>
                <p class="card-text">Nostrum eum sed et autem dolorum perspiciatis. Magni porro quisquam laudantium voluptatem. In molestiae earum ab sit esse voluptatem. Eos ipsam cumque ipsum officiis qui nihil aut incidunt aut</p>
                <div class="read-more"><a href="#"><i class="icofont-arrow-right"></i> Read More</a></div>
              </div>
            </div>
    ...
    <!-- ======= Contact Section ======= -->
    <section id="contact" style="display: none;" class="contact section-bg">
      <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="info-box mt-4" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <h3>Call Us</h3>
                  <p>030 558 5488 55<br>+233 24 254 4451</p>
                </div>
              </div>
            </div>
